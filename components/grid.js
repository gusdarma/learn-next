    ...
    <section class="text-gray-700 body-font">
      <div class="container px-8 pt-48 pb-24 mx-auto lg:px-4">
        <div class="flex flex-wrap text-center">
          <div class="px-8 py-6 lg:px-24 lg:w-2/4 md:w-full rounded-xl bg-gray-200">
            ...
            <h2 class="mb-3 text-lg font-medium title-font text-white">
              Information 1
            </h2>
          ...
          <div class="px-8 py-6 lg:px-24 lg:w-2/4 md:w-full rounded-xl bg-gray-400">
            <div class="inline-flex items-center justify-center flex-shrink-0 w-12 h-12 mb-5 text-blue-800 bg-gray-200 rounded-full">
              <svg
                class="w-6 h-6"
                xmlns="http://www.w3.org/2000/svg"
